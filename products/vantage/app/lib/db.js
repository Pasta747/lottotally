...
export async function initDB() {
  ...
  await sql`CREATE TABLE IF NOT EXISTS trades (id TEXT PRIMARY KEY, user_id TEXT REFERENCES users(id), date DATE NOT NULL, market TEXT NOT NULL, category TEXT NOT NULL, layer TEXT NOT NULL, side TEXT NOT NULL, ev_pct DECIMAL(6,4), kelly_amount DECIMAL(10,2), outcome TEXT DEFAULT 'pending', pnl DECIMAL(10,2) DEFAULT 0, created_at TIMESTAMPTZ DEFAULT NOW())`;
